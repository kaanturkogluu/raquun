    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        @media (max-width: 600px) {
            ...
            .founder-box { flex-direction: column; align-items: flex-start; }
        }
    </style>
</head>
<body>
    ...
    <header class="header">
        <div class="container">
            <div class="header-inner">
                ...
                <div>
                    <a href="#iletisim" class="btn btn-primary" style="padding: 8px 18px; font-size: 0.88rem;">
                        Konuşalım
                    </a>
                </div>
            </div>
    ...
    <main>
        ...
        <section id="iletisim" class="contact-section">
            <div class="container">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:24px; max-width:920px; margin:0 auto 36px auto;">
                    <!-- Kaan Türkoğlu Card -->
                    <div style="background:#ffffff; border:1px solid var(--border); border-radius:var(--radius-lg); padding:32px; display:flex; flex-direction:column; justify-content:space-between; box-shadow:0 2px 8px -2px rgba(0,0,0,0.04);">
                        <div>
